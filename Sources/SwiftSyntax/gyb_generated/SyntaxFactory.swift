...
/// MARK: Syntax Node Creation APIs
  ...
  public static func makeExpressionSegment(backslash: TokenSyntax, leftParen: TokenSyntax, expressions: FunctionCallArgumentListSyntax, rightParen: TokenSyntax) -> ExpressionSegmentSyntax {
    let layout: [RawSyntax?] = [
      backslash.raw,
      leftParen.raw,
      expressions.raw,
