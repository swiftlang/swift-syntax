...
public struct GenericParameterSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  @_spi(ExperimentalLanguageFeatures) public init(
    ...
    _ unexpectedBetweenInheritedTypeAndInitializer: UnexpectedNodesSyntax? = nil,
    ...
    self = withExtendedLifetime((RawSyntaxArena(), (
      ...
      inheritedType,
      unexpectedBetweenInheritedTypeAndInitializer,
      initializer,
      ...
      let layout: [RawSyntax?] = [
        ...
        inheritedType?.raw,
        unexpectedBetweenInheritedTypeAndInitializer?.raw,
        initializer?.raw,
  ...
  public static let structure: SyntaxNodeStructure = .layout([
    ...
    \Self.inheritedType,
    \Self.unexpectedBetweenInheritedTypeAndInitializer,
    \Self.initializer,
