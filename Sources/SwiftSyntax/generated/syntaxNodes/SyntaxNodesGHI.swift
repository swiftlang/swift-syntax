...
public struct GenericParameterSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((RawSyntaxArena(), (
      ...
      let layout: [RawSyntax?] = [
        ...
        inheritedType?.raw,
        unexpectedBetweenInheritedTypeAndEqual?.raw,
        equal?.raw,
        unexpectedBetweenEqualAndDefaultType?.raw,
        defaultType?.raw,
        unexpectedBetweenDefaultTypeAndTrailingComma?.raw,
        trailingComma?.raw,
        unexpectedAfterTrailingComma?.raw
      ]
      let raw = RawSyntax.makeLayout(
  ...
  public var unexpectedBetweenInheritedTypeAndEqual: UnexpectedNodesSyntax? {
    get {
  ...
  public var unexpectedBetweenEqualAndDefaultType: UnexpectedNodesSyntax? {
    get {
  ...
  public var defaultType: TypeSyntax? {
    get {
      return Syntax(self).child(at: 13)?.cast(TypeSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 13, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(GenericParameterSyntax.self)
    }
  }

  public var unexpectedBetweenDefaultTypeAndTrailingComma: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 14)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 14, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(GenericParameterSyntax.self)
    }
  }
  ...
  public var trailingComma: TokenSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 15, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(GenericParameterSyntax.self)
    }
  }
  ...
  public var unexpectedAfterTrailingComma: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 16, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(GenericParameterSyntax.self)
    }
  }
  ...
  public static let structure: SyntaxNodeStructure = .layout([
    ...
    \Self.inheritedType,
    \Self.unexpectedBetweenInheritedTypeAndEqual,
    \Self.equal,
    \Self.unexpectedBetweenEqualAndDefaultType,
    \Self.defaultType,
    \Self.unexpectedBetweenDefaultTypeAndTrailingComma,
    \Self.trailingComma,
    \Self.unexpectedAfterTrailingComma
  ])
}
