...
public struct SourceFileSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be the following kind: `<shebang>`
...
public struct SpecializeAvailabilityArgumentSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be the following kind: `'availability'`
...
public struct SpecializeTargetFunctionArgumentSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be the following kind: `'target'`
...
public struct StructDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be the following kind: `'struct'`
