...
public struct StructDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  ///   - extendedType: The `type` in which this struct is nested.
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
      ...
      let layout: [RawSyntax?] = [
        ...
        structKeyword.raw,
        unexpectedBetweenStructKeywordAndExtendedType?.raw,
        extendedType?.raw,
  ...
  public var unexpectedBetweenStructKeywordAndExtendedType: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 6)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  /// The `type` in which this struct is nested.
  ...
  public var genericWhereClause: GenericWhereClauseSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 17, with: Syntax(value), arena: SyntaxArena()).cast(StructDeclSyntax.self)
    }
  }
  ...
  public var unexpectedBetweenGenericWhereClauseAndMemberBlock: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 18, with: Syntax(value), arena: SyntaxArena()).cast(StructDeclSyntax.self)
    }
  }
  ...
  public var memberBlock: MemberBlockSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 19, with: Syntax(value), arena: SyntaxArena()).cast(StructDeclSyntax.self)
    }
  }
  ...
  public var unexpectedAfterMemberBlock: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 20, with: Syntax(value), arena: SyntaxArena()).cast(StructDeclSyntax.self)
    }
  }
  ...
  public static let structure: SyntaxNodeStructure = .layout([
    ...
    \Self.structKeyword,
    \Self.unexpectedBetweenStructKeywordAndExtendedType,
    \Self.extendedType,
