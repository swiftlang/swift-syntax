...
public struct ImportDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be the following kind: `'import'`
...
public struct InitializerDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be the following kind: `'init'`
