...
public enum SyntaxFactory {
  ...
  public static func makeBorrowExpr(_ unexpectedBeforeBorrowKeyword: UnexpectedNodesSyntax? = nil, borrowKeyword: TokenSyntax, _ unexpectedBetweenBorrowKeywordAndExpression: UnexpectedNodesSyntax? = nil, expression: ExprSyntax) -> BorrowExprSyntax {
    let layout: [RawSyntax?] = [unexpectedBeforeBorrowKeyword?.raw, borrowKeyword.raw, unexpectedBetweenBorrowKeywordAndExpression?.raw, expression.raw]
    return withExtendedLifetime(SyntaxArena()) { arena in 
  ...
  public static func makeBlankBorrowExpr(presence: SourcePresence = .present) -> BorrowExprSyntax {
    return withExtendedLifetime(SyntaxArena()) {arena in 
      let data = SyntaxData.forRoot(RawSyntax.makeLayout(kind: .borrowExpr, from: [RawSyntax.makeEmptyLayout(kind: SyntaxKind.unexpectedNodes, arena: arena)
          , nil
          , RawSyntax.makeEmptyLayout(kind: SyntaxKind.unexpectedNodes, arena: arena)
          , RawSyntax.makeEmptyLayout(kind: SyntaxKind.missingExpr, arena: arena)
          ], arena: arena))
  ...
  public static func makePackExpansionExpr(_ unexpectedBeforeRepeatKeyword: UnexpectedNodesSyntax? = nil, repeatKeyword: TokenSyntax, _ unexpectedBetweenRepeatKeywordAndPatternExpr: UnexpectedNodesSyntax? = nil, patternExpr: ExprSyntax) -> PackExpansionExprSyntax {
    let layout: [RawSyntax?] = [unexpectedBeforeRepeatKeyword?.raw, repeatKeyword.raw, unexpectedBetweenRepeatKeywordAndPatternExpr?.raw, patternExpr.raw]
    return withExtendedLifetime(SyntaxArena()) { arena in 
  ...
  public static func makeBlankPackExpansionExpr(presence: SourcePresence = .present) -> PackExpansionExprSyntax {
    return withExtendedLifetime(SyntaxArena()) {arena in 
      let data = SyntaxData.forRoot(RawSyntax.makeLayout(kind: .packExpansionExpr, from: [RawSyntax.makeEmptyLayout(kind: SyntaxKind.unexpectedNodes, arena: arena)
          , nil
          , RawSyntax.makeEmptyLayout(kind: SyntaxKind.unexpectedNodes, arena: arena)
          , RawSyntax.makeEmptyLayout(kind: SyntaxKind.missingExpr, arena: arena)
          ], arena: arena))
  ...
  public static func makePackExpansionType(_ unexpectedBeforeRepeatKeyword: UnexpectedNodesSyntax? = nil, repeatKeyword: TokenSyntax, _ unexpectedBetweenRepeatKeywordAndPatternType: UnexpectedNodesSyntax? = nil, patternType: TypeSyntax) -> PackExpansionTypeSyntax {
    let layout: [RawSyntax?] = [unexpectedBeforeRepeatKeyword?.raw, repeatKeyword.raw, unexpectedBetweenRepeatKeywordAndPatternType?.raw, patternType.raw]
    return withExtendedLifetime(SyntaxArena()) { arena in 
