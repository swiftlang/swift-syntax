...
public struct RawStmtSyntax: RawStmtSyntaxNodeProtocol {
  ...
  public static func isKindOf(_ raw: RawSyntax) -> Bool {
    switch raw.kind {
    case .missingStmt, .labeledStmt, .expressionStmt, .continueStmt, .whileStmt, .deferStmt, .repeatWhileStmt, .guardStmt, .forInStmt, .doStmt, .returnStmt, .yieldStmt, .fallthroughStmt, .breakStmt, .throwStmt, .poundAssertStmt: return true
    default: return false
    }
  }
