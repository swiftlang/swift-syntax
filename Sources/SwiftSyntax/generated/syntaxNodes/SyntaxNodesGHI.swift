...
/// An inline array type `[3 x Int]`, sugar for `InlineArray<3, Int>`.
///
...
public struct InlineArrayTypeSyntax: TypeSyntaxProtocol, SyntaxHashable, _LeafTypeSyntaxNodeProtocol {
  ...
  public init(
    ...
    separator: TokenSyntax = .keyword(.x),
  ...
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be `x`.
