...
extension SyntaxNode {
  ...
  public var isMultipleTrailingClosureClause: Bool { return raw.kind == .multipleTrailingClosureClause }
  public var asMultipleTrailingClosureClause: MultipleTrailingClosureClauseSyntax? {
    guard isMultipleTrailingClosureClause else { return nil }
    return MultipleTrailingClosureClauseSyntax(asSyntaxData)
  }
...
extension Syntax {
  ...
  public func asProtocol(_: SyntaxProtocol.Protocol) -> SyntaxProtocol {
    ...
    case .multipleTrailingClosureElementList(let node):
      return node
    case .multipleTrailingClosureClause(let node):
      return node
