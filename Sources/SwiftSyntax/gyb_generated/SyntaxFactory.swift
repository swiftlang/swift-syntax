...
/// MARK: Syntax Node Creation APIs
  ...
  public static func makeGenericParameterClause(leftAngleBracket: TokenSyntax, genericParameterList: GenericParameterListSyntax, obsoletedWhereClause: GenericWhereClauseSyntax?, rightAngleBracket: TokenSyntax) -> GenericParameterClauseSyntax {
    let layout: [RawSyntax?] = [
      leftAngleBracket.raw,
      genericParameterList.raw,
      obsoletedWhereClause?.raw,
  ...
  public static func makeLayoutRequirement(leftTypeIdentifier: TypeSyntax, colon: TokenSyntax, layoutConstraint: LayoutConstraintSyntax) -> LayoutRequirementSyntax {
    let layout: [RawSyntax?] = [
      leftTypeIdentifier.raw,
      colon.raw,
  ...
  public static func makeBlankLayoutRequirement() -> LayoutRequirementSyntax {
    let data = SyntaxData.forRoot(RawSyntax.create(kind: .layoutRequirement,
      layout: [
      RawSyntax.missing(SyntaxKind.type),
      RawSyntax.missingToken(TokenKind.colon),
      RawSyntax.missing(SyntaxKind.layoutConstraint),
    ], length: .zero, presence: .present))
    return LayoutRequirementSyntax(data)
  }
  public static func makeLayoutConstraint(name: TokenSyntax, leftParen: TokenSyntax?, size: TokenSyntax?, comma: TokenSyntax?, alignment: TokenSyntax?, rightParen: TokenSyntax?) -> LayoutConstraintSyntax {
    let layout: [RawSyntax?] = [
      name.raw,
      leftParen?.raw,
      size?.raw,
    ...
    let raw = RawSyntax.createAndCalcLength(kind: SyntaxKind.layoutConstraint,
      layout: layout, presence: SourcePresence.present)
    let data = SyntaxData.forRoot(raw)
    return LayoutConstraintSyntax(data)
  }

  public static func makeBlankLayoutConstraint() -> LayoutConstraintSyntax {
    let data = SyntaxData.forRoot(RawSyntax.create(kind: .layoutConstraint,
      layout: [
      RawSyntax.missingToken(TokenKind.identifier("")),
      nil,
      nil,
