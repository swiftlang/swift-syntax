...
public struct ProtocolDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  ///   - extendedType: The `type` in which this protocol is nested.
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
      ...
      let layout: [RawSyntax?] = [
        ...
        protocolKeyword.raw,
        unexpectedBetweenProtocolKeywordAndExtendedType?.raw,
        extendedType?.raw,
  ...
  public var unexpectedBetweenProtocolKeywordAndExtendedType: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 6)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  /// The `type` in which this protocol is nested.
  ...
  public var primaryAssociatedTypeClause: PrimaryAssociatedTypeClauseSyntax? {
    get {
      return Syntax(self).child(at: 13)?.cast(PrimaryAssociatedTypeClauseSyntax.self)
    }
    set(value) {
  ...
  public static let structure: SyntaxNodeStructure = .layout([
    ...
    \Self.unexpectedBetweenProtocolKeywordAndExtendedType,
    \Self.extendedType,
