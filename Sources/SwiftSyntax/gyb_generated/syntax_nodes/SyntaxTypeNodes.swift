...
public struct UnknownTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .unknownType)
...
public struct SimpleTypeIdentifierSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .simpleTypeIdentifier)
    self._syntaxNode = Syntax(data)
  }
...
public struct MemberTypeIdentifierSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .memberTypeIdentifier)
    self._syntaxNode = Syntax(data)
  }
...
public struct ClassRestrictionTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .classRestrictionType)
    self._syntaxNode = Syntax(data)
  }
...
public struct ArrayTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .arrayType)
    self._syntaxNode = Syntax(data)
  }
...
public struct DictionaryTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .dictionaryType)
    self._syntaxNode = Syntax(data)
  }
...
public struct MetatypeTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .metatypeType)
    self._syntaxNode = Syntax(data)
  }
...
public struct OptionalTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .optionalType)
    self._syntaxNode = Syntax(data)
  }
...
public struct SomeTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .someType)
    self._syntaxNode = Syntax(data)
  }
...
public struct ImplicitlyUnwrappedOptionalTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .implicitlyUnwrappedOptionalType)
    self._syntaxNode = Syntax(data)
  }
...
public struct CompositionTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .compositionType)
    self._syntaxNode = Syntax(data)
  }
  ...
  public func _validateLayout() {
    ...
    if let raw = rawChildren[0].raw {
      ...
      let syntaxData = SyntaxData(absoluteRaw, parent: Syntax(self))
      let syntaxChild = Syntax(syntaxData)
      swiftSyntaxAssert(syntaxChild.is(CompositionTypeElementListSyntax.self))
    }
  }
}
...
public struct TupleTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .tupleType)
    self._syntaxNode = Syntax(data)
  }
  ...
  public func _validateLayout() {
    ...
    if let raw = rawChildren[1].raw {
      ...
      let syntaxData = SyntaxData(absoluteRaw, parent: Syntax(self))
      let syntaxChild = Syntax(syntaxData)
      swiftSyntaxAssert(syntaxChild.is(TupleTypeElementListSyntax.self))
    }
    // Check child #2 child is TokenSyntax 
    swiftSyntaxAssert(rawChildren[2].raw != nil)
    if let raw = rawChildren[2].raw {
...
public struct FunctionTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .functionType)
    self._syntaxNode = Syntax(data)
  }
...
public struct AttributedTypeSyntax: TypeSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .attributedType)
    self._syntaxNode = Syntax(data)
  }
