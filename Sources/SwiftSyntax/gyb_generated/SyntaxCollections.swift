// ###sourceLocation(file: "/Users/argiris/proj/opensource/swift-syntax/Sources/SwiftSyntax/SyntaxCollections.swift.gyb", line: 6)
...
// ###sourceLocation(file: "/Users/argiris/proj/opensource/swift-syntax/Sources/SwiftSyntax/SyntaxCollections.swift.gyb", line: 24)
...
// ###sourceLocation(file: "/Users/argiris/proj/opensource/swift-syntax/Sources/SwiftSyntax/SyntaxCollections.swift.gyb", line: 164)
...
/// as a regular Swift collection, and has accessors that return new
/// versions of the collection with different children.
public struct MemberDeclListSyntax: _SyntaxBase {
  let _root: SyntaxData
  unowned let _data: SyntaxData
  ...
  internal func replacingLayout(
    ...
    let newRaw = data.raw.replacingLayout(layout)
    let (newRoot, newData) = data.replacingSelf(newRaw)
    return MemberDeclListSyntax(root: newRoot, data: newData)
  }
  ...
  /// Returns an iterator over the elements of this syntax collection.
  public func makeIterator() -> MemberDeclListSyntaxIterator {
    return MemberDeclListSyntaxIterator(collection: self)
  }
}

/// Conformance for `MemberDeclListSyntax`` to the Collection protocol.
extension MemberDeclListSyntax: Collection {
  public var startIndex: Int {
    return data.childCaches.startIndex
  }
  ...
  public subscript(_ index: Int) -> MemberDeclListItemSyntax {
// ###sourceLocation(file: "/Users/argiris/proj/opensource/swift-syntax/Sources/SwiftSyntax/SyntaxCollections.swift.gyb", line: 164)
    return child(at: index)! as! MemberDeclListItemSyntax
  }
}

/// A type that iterates over a `MemberDeclListSyntax` using its indices.
public struct MemberDeclListSyntaxIterator: IteratorProtocol {
  public typealias Element = MemberDeclListItemSyntax

  private let collection: MemberDeclListSyntax
  private var index: MemberDeclListSyntax.Index

  fileprivate init(collection: MemberDeclListSyntax) {
    self.collection = collection
    self.index = collection.startIndex
  }
...
/// A type that iterates over a `IdentifierListSyntax` using its indices.
...
/// as a regular Swift collection, and has accessors that return new
/// versions of the collection with different children.
public struct NonEmptyTokenListSyntax: _SyntaxBase {
  let _root: SyntaxData
  unowned let _data: SyntaxData
  ...
  internal func replacingLayout(
    ...
    let newRaw = data.raw.replacingLayout(layout)
    let (newRoot, newData) = data.replacingSelf(newRaw)
    return NonEmptyTokenListSyntax(root: newRoot, data: newData)
  }
  ...
  /// Returns an iterator over the elements of this syntax collection.
  public func makeIterator() -> NonEmptyTokenListSyntaxIterator {
    return NonEmptyTokenListSyntaxIterator(collection: self)
  }
}

/// Conformance for `NonEmptyTokenListSyntax`` to the Collection protocol.
extension NonEmptyTokenListSyntax: Collection {
  public var startIndex: Int {
    return data.childCaches.startIndex
  }
...
/// A type that iterates over a `NonEmptyTokenListSyntax` using its indices.
public struct NonEmptyTokenListSyntaxIterator: IteratorProtocol {
  public typealias Element = TokenSyntax

  private let collection: NonEmptyTokenListSyntax
  private var index: NonEmptyTokenListSyntax.Index

  fileprivate init(collection: NonEmptyTokenListSyntax) {
    self.collection = collection
    self.index = collection.startIndex
  }
...
/// as a regular Swift collection, and has accessors that return new
/// versions of the collection with different children.
public struct SpecializeAttributeSpecListSyntax: _SyntaxBase {
  let _root: SyntaxData
  unowned let _data: SyntaxData
  ...
  internal func replacingLayout(
    ...
    let newRaw = data.raw.replacingLayout(layout)
    let (newRoot, newData) = data.replacingSelf(newRaw)
    return SpecializeAttributeSpecListSyntax(root: newRoot, data: newData)
  }
  ...
  /// Returns an iterator over the elements of this syntax collection.
  public func makeIterator() -> SpecializeAttributeSpecListSyntaxIterator {
    return SpecializeAttributeSpecListSyntaxIterator(collection: self)
  }
}

/// Conformance for `SpecializeAttributeSpecListSyntax`` to the Collection protocol.
extension SpecializeAttributeSpecListSyntax: Collection {
  public var startIndex: Int {
    return data.childCaches.startIndex
  }
...
/// A type that iterates over a `SpecializeAttributeSpecListSyntax` using its indices.
public struct SpecializeAttributeSpecListSyntaxIterator: IteratorProtocol {
  public typealias Element = Syntax

  private let collection: SpecializeAttributeSpecListSyntax
  private var index: SpecializeAttributeSpecListSyntax.Index

  fileprivate init(collection: SpecializeAttributeSpecListSyntax) {
    self.collection = collection
    self.index = collection.startIndex
  }
...
/// as a regular Swift collection, and has accessors that return new
/// versions of the collection with different children.
public struct ObjCSelectorSyntax: _SyntaxBase {
  let _root: SyntaxData
  unowned let _data: SyntaxData
  ...
  internal func replacingLayout(
    ...
    let newRaw = data.raw.replacingLayout(layout)
    let (newRoot, newData) = data.replacingSelf(newRaw)
    return ObjCSelectorSyntax(root: newRoot, data: newData)
  }
  ...
  /// Returns an iterator over the elements of this syntax collection.
  public func makeIterator() -> ObjCSelectorSyntaxIterator {
    return ObjCSelectorSyntaxIterator(collection: self)
  }
}

/// Conformance for `ObjCSelectorSyntax`` to the Collection protocol.
extension ObjCSelectorSyntax: Collection {
  public var startIndex: Int {
    return data.childCaches.startIndex
  }
  ...
  public subscript(_ index: Int) -> ObjCSelectorPieceSyntax {
// ###sourceLocation(file: "/Users/argiris/proj/opensource/swift-syntax/Sources/SwiftSyntax/SyntaxCollections.swift.gyb", line: 164)
    return child(at: index)! as! ObjCSelectorPieceSyntax
  }
}

/// A type that iterates over a `ObjCSelectorSyntax` using its indices.
public struct ObjCSelectorSyntaxIterator: IteratorProtocol {
  public typealias Element = ObjCSelectorPieceSyntax

  private let collection: ObjCSelectorSyntax
  private var index: ObjCSelectorSyntax.Index

  fileprivate init(collection: ObjCSelectorSyntax) {
    self.collection = collection
    self.index = collection.startIndex
  }
...
/// as a regular Swift collection, and has accessors that return new
/// versions of the collection with different children.
public struct AvailabilitySpecListSyntax: _SyntaxBase {
  let _root: SyntaxData
  unowned let _data: SyntaxData
  ...
  internal func replacingLayout(
    ...
    let newRaw = data.raw.replacingLayout(layout)
    let (newRoot, newData) = data.replacingSelf(newRaw)
    return AvailabilitySpecListSyntax(root: newRoot, data: newData)
  }
  ...
  /// Returns an iterator over the elements of this syntax collection.
  public func makeIterator() -> AvailabilitySpecListSyntaxIterator {
    return AvailabilitySpecListSyntaxIterator(collection: self)
  }
}

/// Conformance for `AvailabilitySpecListSyntax`` to the Collection protocol.
extension AvailabilitySpecListSyntax: Collection {
  public var startIndex: Int {
    return data.childCaches.startIndex
  }
  ...
  public subscript(_ index: Int) -> AvailabilityArgumentSyntax {
// ###sourceLocation(file: "/Users/argiris/proj/opensource/swift-syntax/Sources/SwiftSyntax/SyntaxCollections.swift.gyb", line: 164)
    return child(at: index)! as! AvailabilityArgumentSyntax
  }
}

/// A type that iterates over a `AvailabilitySpecListSyntax` using its indices.
public struct AvailabilitySpecListSyntaxIterator: IteratorProtocol {
  public typealias Element = AvailabilityArgumentSyntax

  private let collection: AvailabilitySpecListSyntax
  private var index: AvailabilitySpecListSyntax.Index

  fileprivate init(collection: AvailabilitySpecListSyntax) {
    self.collection = collection
    self.index = collection.startIndex
  }
