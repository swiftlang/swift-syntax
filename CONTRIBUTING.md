...
If you are modifying public API, request feedback for these changes from the community by opening a RFC as described by the [RFC Process](https://swiftpackageindex.com/swiftlang/swift-syntax/main/documentation/swiftsyntax/rfc-process).
