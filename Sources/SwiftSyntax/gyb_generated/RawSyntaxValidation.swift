...
func validateLayout(layout: RawSyntaxBuffer, as kind: SyntaxKind) {
  ...
  case .missingDecl:
    ...
    _verify(layout[0], as: RawGarbageNodesSyntax?.self)
    _verify(layout[1], as: RawAttributeListSyntax?.self)
    _verify(layout[2], as: RawGarbageNodesSyntax?.self)
  ...
  case .codeBlockItem:
    ...
    _verify(layout[4], as: RawGarbageNodesSyntax?.self)
  ...
  case .tupleExprElement:
    ...
    _verify(layout[4], as: RawGarbageNodesSyntax?.self)
    _verify(layout[5], as: RawExprSyntax.self)
    _verify(layout[6], as: RawGarbageNodesSyntax?.self)
  ...
  case .ternaryExpr:
    ...
    _verify(layout[6], as: RawGarbageNodesSyntax?.self)
    _verify(layout[7], as: RawTokenSyntax.self)
    _verify(layout[8], as: RawGarbageNodesSyntax?.self)
  ...
  case .closureSignature:
    ...
    _verify(layout[8], as: RawGarbageNodesSyntax?.self)
    _verify(layout[9], as: RawTokenSyntax?.self)
    _verify(layout[10], as: RawGarbageNodesSyntax?.self)
    _verify(layout[11], as: RawReturnClauseSyntax?.self)
    _verify(layout[12], as: RawGarbageNodesSyntax?.self)
  ...
  case .classDecl:
    ...
    _verify(layout[12], as: RawGarbageNodesSyntax?.self)
    _verify(layout[13], as: RawGenericWhereClauseSyntax?.self)
    _verify(layout[14], as: RawGarbageNodesSyntax?.self)
  ...
  case .implementsAttributeArguments:
    assert(layout.count == 8)
    _verify(layout[0], as: RawGarbageNodesSyntax?.self)
    _verify(layout[1], as: RawSimpleTypeIdentifierSyntax.self)
    _verify(layout[2], as: RawGarbageNodesSyntax?.self)
    _verify(layout[3], as: RawTokenSyntax.self)
    _verify(layout[4], as: RawGarbageNodesSyntax?.self)
    _verify(layout[5], as: RawSyntax.self)
  ...
  case .forInStmt:
    ...
    _verify(layout[16], as: RawGarbageNodesSyntax?.self)
    _verify(layout[17], as: RawWhereClauseSyntax?.self)
    _verify(layout[18], as: RawGarbageNodesSyntax?.self)
