...
public struct RawEnumDeclSyntax: RawDeclSyntaxNodeProtocol {
  ...
  public init(
    ...
    _ unexpectedBetweenEnumKeywordAndExtendedType: RawUnexpectedNodesSyntax? = nil,
    ...
    let raw = RawSyntax.makeLayout(
      kind: .enumDecl, uninitializedCount: 21, arena: arena) { layout in
      layout.initialize(repeating: nil)
      layout[0] = unexpectedBeforeAttributes?.raw
      layout[1] = attributes.raw
      layout[2] = unexpectedBetweenAttributesAndModifiers?.raw
      ...
      layout[6] = unexpectedBetweenEnumKeywordAndExtendedType?.raw
  ...
  public var unexpectedBetweenEnumKeywordAndExtendedType: RawUnexpectedNodesSyntax? {
    layoutView.children[6].map(RawUnexpectedNodesSyntax.init(raw:))
  }
