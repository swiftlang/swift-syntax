...
public struct ActorDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  ///   - extendedType: The `type` in which this actor is nested.
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
      ...
      let layout: [RawSyntax?] = [
        ...
        actorKeyword.raw,
        unexpectedBetweenActorKeywordAndExtendedType?.raw,
        extendedType?.raw,
  ...
  public var unexpectedBetweenActorKeywordAndExtendedType: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 6)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  /// The `type` in which this actor is nested.
  ...
  public var genericWhereClause: GenericWhereClauseSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 17, with: Syntax(value), arena: SyntaxArena()).cast(ActorDeclSyntax.self)
    }
  }
  ...
  public var unexpectedBetweenGenericWhereClauseAndMemberBlock: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 18, with: Syntax(value), arena: SyntaxArena()).cast(ActorDeclSyntax.self)
    }
  }
  ...
  public var memberBlock: MemberBlockSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 19, with: Syntax(value), arena: SyntaxArena()).cast(ActorDeclSyntax.self)
    }
  }
  ...
  public var unexpectedAfterMemberBlock: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 20, with: Syntax(value), arena: SyntaxArena()).cast(ActorDeclSyntax.self)
    }
  }
  ...
  public static let structure: SyntaxNodeStructure = .layout([
    ...
    \Self.actorKeyword,
    \Self.unexpectedBetweenActorKeywordAndExtendedType,
    \Self.extendedType,
