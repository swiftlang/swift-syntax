    ...
    children: [
      ...
      Child(
        ...
        kind: .token(choices: [
          ...
          .keyword(text: "func"),
          .keyword(text: "inout"),
          .keyword(text: "_mutating"),
          .keyword(text: "_consuming"),
          .keyword(text: "_borrowing"),
        ]),
        documentation: """
  ...
  Node(
    ...
    children: [
      ...
      Child(
        ...
        kind: .token(choices: [
          .keyword(text: "let"), .keyword(text: "var"), .keyword(text: "inout"),
          .keyword(text: "_mutating"), .keyword(text: "_borrowing"), .keyword(text: "_consuming"),
        ]),
        documentation: """
