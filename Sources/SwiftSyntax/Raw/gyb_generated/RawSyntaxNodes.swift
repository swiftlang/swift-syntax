...
public struct RawDeclSyntax: RawDeclSyntaxNodeProtocol {
  ...
  public static func isKindOf(_ raw: RawSyntax) -> Bool {
    switch raw.kind {
    case .missingDecl, .typealiasDecl, .associatedtypeDecl, .ifConfigDecl, .poundSourceLocation, .classDecl, .actorDecl, .structDecl, .protocolDecl, .extensionDecl, .functionDecl, .initializerDecl, .deinitializerDecl, .subscriptDecl, .importDecl, .accessorDecl, .variableDecl, .enumCaseDecl, .enumDecl, .operatorDecl, .precedenceGroupDecl, .macroDecl, .macroExpansionDecl, .editorPlaceholderDecl: return true
...
public struct RawExprSyntax: RawExprSyntaxNodeProtocol {
  ...
  public static func isKindOf(_ raw: RawSyntax) -> Bool {
    switch raw.kind {
    case .missingExpr, .inOutExpr, .tryExpr, .awaitExpr, .moveExpr, .borrowExpr, .identifierExpr, .superRefExpr, .nilLiteralExpr, .discardAssignmentExpr, .assignmentExpr, .packExpansionExpr, .packElementExpr, .sequenceExpr, .prefixOperatorExpr, .binaryOperatorExpr, .arrowExpr, .infixOperatorExpr, .floatLiteralExpr, .tupleExpr, .arrayExpr, .dictionaryExpr, .integerLiteralExpr, .booleanLiteralExpr, .ifExpr, .switchExpr, .unresolvedTernaryExpr, .ternaryExpr, .memberAccessExpr, .unresolvedIsExpr, .isExpr, .unresolvedAsExpr, .asExpr, .typeExpr, .closureExpr, .unresolvedPatternExpr, .functionCallExpr, .subscriptExpr, .optionalChainingExpr, .forcedValueExpr, .postfixUnaryExpr, .specializeExpr, .stringLiteralExpr, .regexLiteralExpr, .keyPathExpr, .macroExpansionExpr, .postfixIfConfigExpr, .editorPlaceholderExpr: return true
    default: return false
    }
  }
...
public struct RawStmtSyntax: RawStmtSyntaxNodeProtocol {
  ...
  public static func isKindOf(_ raw: RawSyntax) -> Bool {
    switch raw.kind {
    case .missingStmt, .labeledStmt, .expressionStmt, .continueStmt, .whileStmt, .deferStmt, .repeatWhileStmt, .guardStmt, .forInStmt, .doStmt, .returnStmt, .yieldStmt, .fallthroughStmt, .breakStmt, .throwStmt: return true
    default: return false
    }
  }
...
public struct RawPatternSyntax: RawPatternSyntaxNodeProtocol {
  ...
  public static func isKindOf(_ raw: RawSyntax) -> Bool {
    switch raw.kind {
    case .missingPattern, .isTypePattern, .identifierPattern, .tuplePattern, .wildcardPattern, .expressionPattern, .valueBindingPattern: return true
    default: return false
    }
  }
...
public struct RawIfExprSyntax: RawExprSyntaxNodeProtocol {
  ...
  public enum ElseBody: RawSyntaxNodeProtocol {
    ...
    public var raw: RawSyntax {
      switch self {
      case .ifExpr(let node): return node.raw
...
public struct RawPackageAttributeArgumentsSyntax: RawSyntaxNodeProtocol {
  ...
  public init(
    _ unexpectedBeforeDescription: RawUnexpectedNodesSyntax? = nil,
    description: Description,
    _ unexpectedBetweenDescriptionAndComma: RawUnexpectedNodesSyntax? = nil,
    comma: RawTokenSyntax?,
    _ unexpectedBetweenCommaAndProduct: RawUnexpectedNodesSyntax? = nil,
    product: RawPackageProductSyntax?,
    _ unexpectedAfterProduct: RawUnexpectedNodesSyntax? = nil,
    arena: __shared SyntaxArena
  ) {
    let raw = RawSyntax.makeLayout(
      kind: .packageAttributeArguments, uninitializedCount: 7, arena: arena) { layout in
      layout.initialize(repeating: nil)
      layout[0] = unexpectedBeforeDescription?.raw
      layout[1] = description.raw
      layout[2] = unexpectedBetweenDescriptionAndComma?.raw
      layout[3] = comma?.raw
      layout[4] = unexpectedBetweenCommaAndProduct?.raw
      layout[5] = product?.raw
      layout[6] = unexpectedAfterProduct?.raw
    }
    self.init(raw: raw)
  }

  public var unexpectedBeforeDescription: RawUnexpectedNodesSyntax? {
    layoutView.children[0].map(RawUnexpectedNodesSyntax.init(raw:))
  }
  public var description: RawSyntax {
    layoutView.children[1]!
  }
  public var unexpectedBetweenDescriptionAndComma: RawUnexpectedNodesSyntax? {
    layoutView.children[2].map(RawUnexpectedNodesSyntax.init(raw:))
  }
  public var comma: RawTokenSyntax? {
    layoutView.children[3].map(RawTokenSyntax.init(raw:))
  }
  public var unexpectedBetweenCommaAndProduct: RawUnexpectedNodesSyntax? {
    layoutView.children[4].map(RawUnexpectedNodesSyntax.init(raw:))
  }
  public var product: RawPackageProductSyntax? {
    layoutView.children[5].map(RawPackageProductSyntax.init(raw:))
  }
  public var unexpectedAfterProduct: RawUnexpectedNodesSyntax? {
    layoutView.children[6].map(RawUnexpectedNodesSyntax.init(raw:))
  }
}

@_spi(RawSyntax)
public struct RawPackageProductSyntax: RawSyntaxNodeProtocol {
  ...
  public static func isKindOf(_ raw: RawSyntax) -> Bool {
    return raw.kind == .packageProduct
  }
  ...
  public init(
    ...
    name: RawStringLiteralExprSyntax,
    _ unexpectedAfterName: RawUnexpectedNodesSyntax? = nil,
    arena: __shared SyntaxArena
  ) {
    let raw = RawSyntax.makeLayout(
      kind: .packageProduct, uninitializedCount: 7, arena: arena) { layout in
      layout.initialize(repeating: nil)
      layout[0] = unexpectedBeforeLabel?.raw
      layout[1] = label.raw
      layout[2] = unexpectedBetweenLabelAndColon?.raw
      layout[3] = colon.raw
      layout[4] = unexpectedBetweenColonAndName?.raw
      layout[5] = name.raw
      layout[6] = unexpectedAfterName?.raw
    }
    self.init(raw: raw)
  }
  ...
  public var name: RawStringLiteralExprSyntax {
    layoutView.children[5].map(RawStringLiteralExprSyntax.init(raw:))!
  }
  public var unexpectedAfterName: RawUnexpectedNodesSyntax? {
    layoutView.children[6].map(RawUnexpectedNodesSyntax.init(raw:))
...
public struct RawFileSystemPackageDescriptionSyntax: RawSyntaxNodeProtocol {
  ...
  public init(
    ...
    _ unexpectedBetweenLabelAndColon: RawUnexpectedNodesSyntax? = nil,
    colon: RawTokenSyntax,
    _ unexpectedBetweenColonAndPath: RawUnexpectedNodesSyntax? = nil,
    path: RawStringLiteralExprSyntax,
    _ unexpectedAfterPath: RawUnexpectedNodesSyntax? = nil,
    arena: __shared SyntaxArena
  ) {
    let raw = RawSyntax.makeLayout(
      ...
      layout[2] = unexpectedBetweenLabelAndColon?.raw
      layout[3] = colon.raw
      layout[4] = unexpectedBetweenColonAndPath?.raw
      layout[5] = path.raw
      layout[6] = unexpectedAfterPath?.raw
    }
    self.init(raw: raw)
  }
  ...
  public var unexpectedBetweenColonAndPath: RawUnexpectedNodesSyntax? {
    layoutView.children[4].map(RawUnexpectedNodesSyntax.init(raw:))
  }
  public var path: RawStringLiteralExprSyntax {
    layoutView.children[5].map(RawStringLiteralExprSyntax.init(raw:))!
  }
  public var unexpectedAfterPath: RawUnexpectedNodesSyntax? {
    layoutView.children[6].map(RawUnexpectedNodesSyntax.init(raw:))
...
public struct RawAvailabilityVersionRestrictionListSyntax: RawSyntaxNodeProtocol {
  ...
  public var elements: [RawAvailabilityVersionRestrictionListEntrySyntax] {
    layoutView.children.map { RawAvailabilityVersionRestrictionListEntrySyntax(raw: $0!) }
  }
}
...
public struct RawDocumentationAttributeArgumentsSyntax: RawSyntaxNodeProtocol {
  ...
  public var elements: [RawDocumentationAttributeArgumentSyntax] {
    layoutView.children.map { RawDocumentationAttributeArgumentSyntax(raw: $0!) }
  }
}
