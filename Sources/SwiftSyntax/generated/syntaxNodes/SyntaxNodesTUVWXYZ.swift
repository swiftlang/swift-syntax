...
/// ### Contained in
/// 
///  - ``ArrowExprSyntax``.``ArrowExprSyntax/yieldsClause``
///  - ``ClosureSignatureSyntax``.``ClosureSignatureSyntax/yieldsClause``
///  - ``FunctionSignatureSyntax``.``FunctionSignatureSyntax/yieldsClause``
///  - ``FunctionTypeSyntax``.``FunctionTypeSyntax/yieldsClause``
///  - ``SubscriptDeclSyntax``.``SubscriptDeclSyntax/yieldsClause``
public struct YieldsClauseSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  public let _syntaxNode: Syntax

  public init?(_ node: __shared some SyntaxProtocol) {
    guard node.raw.kind == .yieldsClause else {
      return nil
    }
    self._syntaxNode = node._syntaxNode
  }
  ...
  ///   - leftParen: The '(' to open the yield type specification.
  ///   - type: The yielded type.
  ///   - rightParen: The ')' to close the yield type specification.
  ///   - trailingTrivia: Trivia to be appended to the trailing trivia of the node’s last token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  public init(
    leadingTrivia: Trivia? = nil,
  ...
  public var unexpectedBeforeYieldsKeyword: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 0, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(YieldsClauseSyntax.self)
    }
  }
  ...
  public var yieldsKeyword: TokenSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 1, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(YieldsClauseSyntax.self)
    }
  }
  ...
  public var unexpectedBetweenYieldsKeywordAndLeftParen: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 2, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(YieldsClauseSyntax.self)
    }
  }

  /// The '(' to open the yield type specification.
  ///
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be `(`.
  public var leftParen: TokenSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 3, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(YieldsClauseSyntax.self)
    }
  }
  ...
  public var unexpectedBetweenLeftParenAndType: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 4, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(YieldsClauseSyntax.self)
    }
  }
  ...
  public var type: TypeSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 5, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(YieldsClauseSyntax.self)
    }
  }
  ...
  public var unexpectedBetweenTypeAndRightParen: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 6, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(YieldsClauseSyntax.self)
    }
  }

  /// The ')' to close the yield type specification.
  ///
  /// ### Tokens
  /// 
  /// For syntax trees generated by the parser, this is guaranteed to be `)`.
  public var rightParen: TokenSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 7, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(YieldsClauseSyntax.self)
    }
  }
  ...
  public var unexpectedAfterRightParen: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 8, with: Syntax(value), rawAllocationArena: RawSyntaxArena()).cast(YieldsClauseSyntax.self)
    }
  }
