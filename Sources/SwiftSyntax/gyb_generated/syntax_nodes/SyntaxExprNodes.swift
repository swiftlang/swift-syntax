...
public struct IfExprSyntax: ExprSyntaxProtocol, SyntaxHashable {
  public enum ElseBody: SyntaxChildChoices {
    ...
    public var _syntaxNode: Syntax {
      switch self {
      case .ifExpr(let node): return node._syntaxNode
  ...
  public init?<S: SyntaxProtocol>(_ node: S) {
    guard node.raw.kind == .ifExpr else { return nil }
    self._syntaxNode = node._syntaxNode
  }
  ...
  public init(
    ...
    let data: SyntaxData = withExtendedLifetime(SyntaxArena()) { arena in
      let raw = RawSyntax.makeLayout(
        kind: SyntaxKind.ifExpr, from: layout, arena: arena,
        leadingTrivia: leadingTrivia, trailingTrivia: trailingTrivia)
      return SyntaxData.forRoot(raw)
    }
    self.init(data)
  ...
  public func withUnexpectedBeforeIfKeyword(_ newChild: UnexpectedNodesSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 0, with: raw, arena: arena)
  ...
  public func withIfKeyword(_ newChild: TokenSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
  ...
  public func withUnexpectedBetweenIfKeywordAndConditions(_ newChild: UnexpectedNodesSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 2, with: raw, arena: arena)
    return IfExprSyntax(newData)
  ...
  public func withConditions(_ newChild: ConditionElementListSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
  ...
  public func withUnexpectedBetweenConditionsAndBody(_ newChild: UnexpectedNodesSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 4, with: raw, arena: arena)
    return IfExprSyntax(newData)
  ...
  public func withBody(_ newChild: CodeBlockSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
  ...
  public func withUnexpectedBetweenBodyAndElseKeyword(_ newChild: UnexpectedNodesSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 6, with: raw, arena: arena)
    return IfExprSyntax(newData)
  ...
  public func withElseKeyword(_ newChild: TokenSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
  ...
  public func withUnexpectedBetweenElseKeywordAndElseBody(_ newChild: UnexpectedNodesSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
  ...
  public func withElseBody(_ newChild: ElseBody?) -> IfExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
  ...
  public func withUnexpectedAfterElseBody(_ newChild: UnexpectedNodesSyntax?) -> IfExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
...
public struct SwitchExprSyntax: ExprSyntaxProtocol, SyntaxHashable {
  ...
  public init?<S: SyntaxProtocol>(_ node: S) {
    guard node.raw.kind == .switchExpr else { return nil }
    self._syntaxNode = node._syntaxNode
  }
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    assert(data.raw.kind == .switchExpr)
    self._syntaxNode = Syntax(data)
  }
  ...
  public init<E: ExprSyntaxProtocol>(
    ...
    let data: SyntaxData = withExtendedLifetime(SyntaxArena()) { arena in
      let raw = RawSyntax.makeLayout(
        kind: SyntaxKind.switchExpr, from: layout, arena: arena,
        leadingTrivia: leadingTrivia, trailingTrivia: trailingTrivia)
      return SyntaxData.forRoot(raw)
    }
    self.init(data)
  ...
  public func withUnexpectedBeforeSwitchKeyword(_ newChild: UnexpectedNodesSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 0, with: raw, arena: arena)
  ...
  public func withSwitchKeyword(_ newChild: TokenSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
  ...
  public func withUnexpectedBetweenSwitchKeywordAndExpression(_ newChild: UnexpectedNodesSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 2, with: raw, arena: arena)
    return SwitchExprSyntax(newData)
  ...
  /// - param newChild: The new `expression` to replace the node's
  ///                   current `expression`, if present.
  public func withExpression(_ newChild: ExprSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw ?? RawSyntax.makeEmptyLayout(kind: SyntaxKind.missingExpr, arena: arena)
    let newData = data.replacingChild(at: 3, with: raw, arena: arena)
    return SwitchExprSyntax(newData)
  ...
  public func withUnexpectedBetweenExpressionAndLeftBrace(_ newChild: UnexpectedNodesSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 4, with: raw, arena: arena)
    return SwitchExprSyntax(newData)
  ...
  public func withLeftBrace(_ newChild: TokenSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
  ...
  public func withUnexpectedBetweenLeftBraceAndCases(_ newChild: UnexpectedNodesSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 6, with: raw, arena: arena)
    return SwitchExprSyntax(newData)
  ...
  public func withCases(_ newChild: SwitchCaseListSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
  ...
  public func withUnexpectedBetweenCasesAndRightBrace(_ newChild: UnexpectedNodesSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 8, with: raw, arena: arena)
    return SwitchExprSyntax(newData)
  ...
  public func withRightBrace(_ newChild: TokenSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
  ...
  public func withUnexpectedAfterRightBrace(_ newChild: UnexpectedNodesSyntax?) -> SwitchExprSyntax {
    let arena = SyntaxArena()
    let raw = newChild?.raw
    let newData = data.replacingChild(at: 10, with: raw, arena: arena)
    return SwitchExprSyntax(newData)
