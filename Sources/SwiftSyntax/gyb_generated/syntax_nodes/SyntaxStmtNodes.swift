...
public struct UnknownStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .unknownStmt)
...
public struct ContinueStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .continueStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct WhileStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .whileStmt)
    self._syntaxNode = Syntax(data)
  }
  ...
  public func _validateLayout() {
    ...
    if let raw = rawChildren[3].raw {
      ...
      let syntaxData = SyntaxData(absoluteRaw, parent: Syntax(self))
      let syntaxChild = Syntax(syntaxData)
      swiftSyntaxAssert(syntaxChild.is(ConditionElementListSyntax.self))
    }
...
public struct DeferStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .deferStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct ExpressionStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .expressionStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct RepeatWhileStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .repeatWhileStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct GuardStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .guardStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct ForInStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .forInStmt)
    self._syntaxNode = Syntax(data)
  }
  ...
  public func _validateLayout() {
    let rawChildren = Array(RawSyntaxChildren(Syntax(self)))
    swiftSyntaxAssert(rawChildren.count == 12)
    // Check child #0 child is TokenSyntax or missing
    if let raw = rawChildren[0].raw {
      let info = rawChildren[0].syntaxInfo
      let absoluteRaw = AbsoluteRawSyntax(raw: raw, info: info)
    ...
    swiftSyntaxAssert(rawChildren[8].raw != nil)
    ...
    swiftSyntaxAssert(rawChildren[9].raw != nil)
    ...
    swiftSyntaxAssert(rawChildren[11].raw != nil)
...
public struct SwitchStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .switchStmt)
    self._syntaxNode = Syntax(data)
  }
  ...
  public func _validateLayout() {
    ...
    if let raw = rawChildren[5].raw {
      ...
      let syntaxData = SyntaxData(absoluteRaw, parent: Syntax(self))
      let syntaxChild = Syntax(syntaxData)
      swiftSyntaxAssert(syntaxChild.is(SwitchCaseListSyntax.self))
    }
...
public struct DoStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .doStmt)
    self._syntaxNode = Syntax(data)
  }
  ...
  public func _validateLayout() {
    ...
    if let raw = rawChildren[4].raw {
      ...
      let syntaxData = SyntaxData(absoluteRaw, parent: Syntax(self))
      let syntaxChild = Syntax(syntaxData)
      swiftSyntaxAssert(syntaxChild.is(CatchClauseListSyntax.self))
    }
  }
}
...
public struct ReturnStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .returnStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct YieldStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .yieldStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct FallthroughStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .fallthroughStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct BreakStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .breakStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct DeclarationStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .declarationStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct ThrowStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .throwStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct IfStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .ifStmt)
    self._syntaxNode = Syntax(data)
  }
...
public struct PoundAssertStmtSyntax: StmtSyntaxProtocol, SyntaxHashable {
  ...
  /// is undefined.
  internal init(_ data: SyntaxData) {
    swiftSyntaxAssert(data.raw.kind == .poundAssertStmt)
    self._syntaxNode = Syntax(data)
  }
