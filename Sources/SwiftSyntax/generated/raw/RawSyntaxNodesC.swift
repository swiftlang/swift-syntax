...
public struct RawClassDeclSyntax: RawDeclSyntaxNodeProtocol {
  ...
  public init(
    ...
    _ unexpectedBetweenClassKeywordAndExtendedType: RawUnexpectedNodesSyntax? = nil,
    ...
    let raw = RawSyntax.makeLayout(
      kind: .classDecl, uninitializedCount: 21, arena: arena) { layout in
      layout.initialize(repeating: nil)
      ...
      layout[6] = unexpectedBetweenClassKeywordAndExtendedType?.raw
  ...
  public var unexpectedBetweenClassKeywordAndExtendedType: RawUnexpectedNodesSyntax? {
    layoutView.children[6].map(RawUnexpectedNodesSyntax.init(raw:))
  }
