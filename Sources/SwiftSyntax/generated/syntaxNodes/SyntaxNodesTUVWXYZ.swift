...
public struct TypeAliasDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  /// - Parameters:
  ///   - leadingTrivia: Trivia to be prepended to the leading trivia of the node’s first token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  ///   - extendedType: The `type` in which this type alias is nested.
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
      ...
      let layout: [RawSyntax?] = [
        ...
        unexpectedBetweenTypealiasKeywordAndExtendedType?.raw,
        extendedType?.raw,
  ...
  public var unexpectedBetweenTypealiasKeywordAndExtendedType: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 6)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  /// The `type` in which this type alias is nested.
  ...
  public var initializer: TypeInitializerClauseSyntax {
    get {
      return Syntax(self).child(at: 15)!.cast(TypeInitializerClauseSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 15, with: Syntax(value), arena: SyntaxArena()).cast(TypeAliasDeclSyntax.self)
    }
  }
  ...
  public var unexpectedBetweenInitializerAndGenericWhereClause: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 16, with: Syntax(value), arena: SyntaxArena()).cast(TypeAliasDeclSyntax.self)
    }
  }
  ...
  public var genericWhereClause: GenericWhereClauseSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 17, with: Syntax(value), arena: SyntaxArena()).cast(TypeAliasDeclSyntax.self)
    }
  }
  ...
  public var unexpectedAfterGenericWhereClause: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 18, with: Syntax(value), arena: SyntaxArena()).cast(TypeAliasDeclSyntax.self)
    }
  }
  ...
  public static let structure: SyntaxNodeStructure = .layout([
    ...
    \Self.unexpectedBetweenTypealiasKeywordAndExtendedType,
    \Self.extendedType,
