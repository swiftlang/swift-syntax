...
public struct EnumCaseParameterSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
      ...
      modifiers: DeclModifierListSyntax = [],
      _ unexpectedBetweenModifiersAndName: UnexpectedNodesSyntax? = nil,
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            modifiers, 
            unexpectedBetweenModifiersAndName, 
            name, 
      ...
      let layout: [RawSyntax?] = [
          ...
          modifiers.raw, 
          unexpectedBetweenModifiersAndName?.raw, 
          name?.raw, 
  ...
  public var unexpectedBetweenModifiersAndName: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 2)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  public var defaultValue: InitializerClauseSyntax? {
    get {
      return Syntax(self).child(at: 9)?.cast(InitializerClauseSyntax.self)
    }
    set(value) {
  ...
  public static var structure: SyntaxNodeStructure {
    return .layout([
          ...
          \Self.modifiers, 
          \Self.unexpectedBetweenModifiersAndName, 
          \Self.name, 
